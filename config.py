...
class Config(object):
    ...
    BLOB_STORAGE_KEY = (
        ...
        or "dkn1npVuVO3PO8wy91RwkUhf05oHPRIY+aZL83AEosWqyZTrqLgNSUFgEJzJ3OT21vp+MBn+RgZ7+ASt9HEJ6g=="
    )

    BLOB_CONTAINER = os.environ.get("BLOB_CONTAINER") or "article-images"

    SQL_SERVER = os.environ.get("SQL_SERVER") or "cms-project-as.azurewebsites.net"
